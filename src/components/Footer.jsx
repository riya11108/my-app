        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">SmartLease</span>
            </Link>
            <p className="text-gray-400 text-sm">
              Making rental housing accessible and transparent for everyone across India. Find your perfect home today.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/listings" className="text-gray-400 hover:text-white transition-colors">Listings</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Rental Guide</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">hello@rentfinder.com</span>
              </div>
              <div className="flex items-center space-x-2">
